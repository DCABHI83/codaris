...
const Hero = () => {
  return (
   ...
   <div className='flex flex-col gap-4 max-w-2xl'>
    ...
    {/* SEO Keyword Line Added */}
  <h1 className='text-xl text-[#5d5353] text-center'>
  Trusted as the Best IT Service in Noida for fast-growing brands
</h1>
   </div>
   ...
   <div className='flex flex-col sm:flex-row gap-4 mt-10'>
    ...
    >
      <span className='relative inline-block transition-transform duration-300 ease-out'>
        Book a Call
      </span>
    ...
    <a 
      href="#pricing"
      className='group relative overflow-hidden bg-white text-[#E34400] border-2 border-[#E34400] rounded-full px-8 py-3 font-medium transition-all duration-300 hover:bg-[#e55011] hover:text-white hover:shadow-lg text-center'
    >
      <span className='relative inline-block transition-transform duration-300 ease-out'>
        See Pricing
      </span>
